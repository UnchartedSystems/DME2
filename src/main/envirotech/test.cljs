(ns envirotech.test
  #_(:require [envirotech.elements :refer (p)]))

(defn sample []
  [:div.mx-5
   [:div {:class [:container "max-w-[73ch]"]}
    [:h1.my-6.text-center "A Breakthrough Technology for In-Situ Bitumen Recovery"]
    [:p.my-6 "Our global energy system faces stark challenges on the horizon. "
    ...
    [:p.my-6 "The " [:em "Steam Assisted Gravity Drainage (SAGD)"]  " technology that  powered the rise of the oil sands for over three decades has become the  root of problems that now threaten the continued survival of the  Canadian oil sands industry. "
    ...
    [:p.my-6 "The " [:em "Dimethyl Ether (DME)"] " based recovery technology outlined  here can become an engine of clean, sustainable growth for the Canadian  oil sands for decades to come. "
    ...
    [:p.my-6 [:em "All claims and figures are discussed in detail in the PDF resources located at the bottom of the page."]]]])
